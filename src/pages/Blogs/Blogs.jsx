...
import { deletePlace } from '../../helpers/places.api'
              ...
              blogs && blogs.map(blog => (
                <tr key={crypto.randomUUID()} className='flex flex-row gap-3 px-5 justify-between items-center w-full mt-5'>
                  ...
                  <th className='flex flex-row items-center gap-2 font-londrina text-sm font-extralight w-20'>
                    <div className='bg-[#c9f3f2] p-1.5 rounded-full cursor-pointer' onClick={ () => { setAction('Edit'); dispatch(activeModal(true)); dispatch(changeId(blog._id)) } }><MdEdit className='text-[#3ec7c1]' size={20} /></div>
